...
def main():
    ...
    while True:
        ...
        if not sleeping:
            ...
            text_tex.render((screen_w / 2 - text_w / 2, screen_h / 2 - text_h / 2, text_w, text_h))

            if x is not None:
                #screen.blit(icon, (x - icon_w / 2, y - icon_h / 2))
                icon_tex.render((x - icon_w / 2, y - icon_h / 2, icon_w, icon_h))
